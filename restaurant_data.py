...
def favorite_restaurant():
    ...
    favorite_restaurant['address'] = input(f"What is the address of {favorite_restaurant['name']}?")
    favorite_restaurant['favorite_dish'] = input(f"What is your favorite dish at {favorite_restaurant['name']}?")
